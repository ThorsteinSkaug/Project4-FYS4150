...
plt.show()
plot([n_cycles, n_cycles, n_cycles], [T1_0[4], T1_1[4], chi_a], title = r"$\chi$ for L=2 and T=1 $J/k_B$", x_label = "Number of MCMC cycles", y_label = r"$\chi$ [ $J^{-1}$]", label = ["Unordered", "Ordered", "Analytical"])
...
n_cycles2 = T2_0[0]
plot([n_cycles2[1:100], n_cycles2[1:100]], [T2_0[1][1:100], T2_1[1][1:100]], title = r"$\langle \epsilon \rangle$ for L=20 with T=2.4 $J/k_B$", x_label = "Number of MCMC cycles", y_label = r"$\langle \epsilon \rangle$ [ $J$]", label = ["Unordered", "Ordered"])
plt.savefig('eL=20.pdf', dpi=900)
plt.show()
plot([n_cycles2[1:100], n_cycles2[1:100]], [T2_0[2][1:100], T2_1[2][1:100]], title = r"$\langle |m| \rangle$ for L=20 with T=2.4 $J/k_B$", x_label = "Number of MCMC cycles", y_label = r"$\langle |m| \rangle$", label = ["Unordered", "Ordered"])
...
n_cycles3 = T3_0[0]
plot([n_cycles3[1:100], n_cycles3[1:100]], [T3_0[1][1:100], T3_1[1][1:100]], title = r"$\langle \epsilon \rangle$ for L=20 with T=1 $J/k_B$", x_label = "Number of MCMC cycles", y_label = r"$\langle \epsilon \rangle$ [ $J$]", label = ["Unordered", "Ordered"])
plt.savefig('eL=20T=1.pdf', dpi=900)
plt.show()
plot([n_cycles3[1:100], n_cycles3[1:100]], [T3_0[2][1:100], T3_1[2][1:100]], title = r"$\langle |m| \rangle$ for L=20 with T=1 $J/k_B$", x_label = "Number of MCMC cycles", y_label = r"$\langle |m| \rangle$", label = ["Unordered", "Ordered"])
